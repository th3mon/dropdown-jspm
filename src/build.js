...
System.registerDynamic("dropdown/dropdownData.json!github:systemjs/plugin-json@0.1.0.js", [], true, function($__require, exports, module) {
  ;
  var global = this,
...
System.register('dropdown/dropdown.js', ['npm:jquery@2.2.0.js', 'dropdown/dropdownData.json!github:systemjs/plugin-json@0.1.0.js'], function (_export) {
    'use strict';
    var $, dropdownData, html, view, $select, dropdown;
    return {
        setters: [function (_npmJquery220Js) {
            $ = _npmJquery220Js['default'];
        }, function (_dropdownDropdownDataJsonGithubSystemjsPluginJson010Js) {
            dropdownData = _dropdownDropdownDataJsonGithubSystemjsPluginJson010Js['default'];
        }],
        execute: function () {
            html = ['<div class="panel panel-default" style="margin:50px">', '<div class="panel-heading">', 'Select:', '</div>', '<div class="panel-body">', '<select></select>', '</div>', '</div>'].join('');
...
System.register("github:twbs/bootstrap@3.3.6/css/bootstrap.css!github:systemjs/plugin-css@0.1.20.js", [], function() { return { setters: [], execute: function() {} } });

System.register('startup.js', ['github:twbs/bootstrap@3.3.6/css/bootstrap.css!github:systemjs/plugin-css@0.1.20.js'], function (_export) {
    'use strict';

    return {
        setters: [function (_githubTwbsBootstrap336CssBootstrapCssGithubSystemjsPluginCss0120Js) {}],
        execute: function () {

            System['import']('dropdown/dropdown').then(function (dropdown) {
                return console.log(dropdown.dropdown.value());
            });
        }
    };
});
System.register('github:twbs/bootstrap@3.3.6/css/bootstrap.css!github:systemjs/plugin-css@0.1.20.js', [], false, function() {});
